...
def compute_ridge_xy(frames_psi, Emix, x_vis_1d, y_vis_1d, mode='argmax', top_q=0.02, radius=20, alpha_smooth=0.0):
    ...
    for i in range(1, Nt_):
        ...
        if mode == 'argmax':
            ...
            xi, yi, si, prev_ix, prev_iy = ridge_localmax_track(Gamma, x_vis_1d, y_vis_1d, prev_ix, prev_iy, radius=radius)
        else:
